...
switch ($page) {
    ...
    case 'search_user_profile': require_once '../src/user_management/boundary/SearchUserProfileUI.php'; break;
    case 'suspend_user_profile': require_once '../src/user_management/boundary/SuspendUserProfileUI.php'; break;
    ...
    case 'search_user_account': require_once '../src/user_management/boundary/SearchUserAccountUI.php'; break;
